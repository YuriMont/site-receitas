          ...
          return (
            <div className="cursor-pointer tracking-wide">
              <img
                src={bolo}
                alt="image"
                className="w-[320px] h-[213px] rounded-md hover:scale-110 transition-transform"
              />
              <span className="flex items-center justify-between px-4 py-2">
                <h3 className="text-xl font-light hover:text-gray-600 transition-colors">
                  Bolo de chocolate
                </h3>
                <span className="p-2 cursor-pointer hover:bg-gray-200 transition-colors rounded-full">
